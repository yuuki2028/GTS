...
public class SteamHighImprovedCoalBoiler extends SteamBoiler {

    public SteamHighImprovedCoalBoiler(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, isHighPressure, Textures.COAL_BOILER_OVERLAY, 300);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new SteamHighImprovedCoalBoiler(metaTileEntityId, isHighPressure);
    }
