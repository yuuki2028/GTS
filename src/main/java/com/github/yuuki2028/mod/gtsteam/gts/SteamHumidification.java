...
public class SteamHumidification extends SteamMetaTileEntity {

    public SteamHumidification(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, GTSReciepMaps.HUMIDIFICATION_RECIPES, Textures.ARC_FURNACE_OVERLAY, isHighPressure);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new SteamHumidification(metaTileEntityId, isHighPressure);
    }
