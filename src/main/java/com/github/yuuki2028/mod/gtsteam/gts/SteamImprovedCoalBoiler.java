...
public class SteamImprovedCoalBoiler extends SteamBoiler {

    public SteamImprovedCoalBoiler(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, isHighPressure, Textures.COAL_BOILER_OVERLAY, 200);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new SteamImprovedCoalBoiler(metaTileEntityId, isHighPressure);
    }
